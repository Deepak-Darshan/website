...
export default function Projects({ darkMode }) {
  ...
  return (
    ...
    >
      ...
      {/* ── Rock & sand decorations ──────────────────────────────────────────── */}
      {darkMode && (
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }}>
          {/* Rock 1 — large rough stone, top-left */}
          ...
          {/* Rock 2 — angular dark shard, right mid */}
          ...
          {/* Rock 4 — wide flat sedimentary slab */}
